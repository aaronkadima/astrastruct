...
export function AnalysisPanelV13({project,onClose,onCommit}:Props){
  ...
  const followerLoads=(project.elementLoads||[]).filter((l:any)=>l.kind==='followerEnd');
