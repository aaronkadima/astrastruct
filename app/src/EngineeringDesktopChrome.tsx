...
function ResultLegend({maxDisp,shells}:{maxDisp:number;shells:number}){
  ...
  const changeZeroLabels=(checked:boolean)=>{const core=document.querySelector<HTMLInputElement>('[data-testid="spatial3d-diagram-zero-labels"]');if(core&&core.checked!==checked)core.click()};
  return <>
