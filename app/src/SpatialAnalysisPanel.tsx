...
export function SpatialAnalysisPanel({project,onClose,onCommit}:Props){
  ...
  const followerCount=(project.elementLoads||[]).filter((l:any)=>l.kind==='followerEnd').length,springCount=(project.nodeSprings||[]).length;
