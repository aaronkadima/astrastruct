...
function renderDxf(host:HTMLElement){
  host.innerHTML=`<p class="astra-lab-note"><b>Importação DXF:</b> leitura vetorial de LINE e LWPOLYLINE. Selecione apenas as layers que representam eixos/vigas estruturais; o arquivo original não é alterado.</p>
