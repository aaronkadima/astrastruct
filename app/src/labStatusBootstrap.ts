...
function patchLabStatus(){
  document.querySelectorAll<HTMLElement>('[data-testid="model-lab-overlay"]').forEach(overlay=>{
    ...
    if(!note||note.dataset.capabilitiesV0301==='1')return;
    note.dataset.capabilitiesV0301='1';
    note.innerHTML='<b>Lab v0.30.1:</b> vigas, pilares e barras isoladas usam os solvers estruturais do AstraStruct. <b>Ancoragem / pull-out</b> possui kernel dedicado de aderência τ–s com pós-pico. <b>Ligação chapa–parafuso</b> inclui distribuição elástica Fx/Fy/Mz, contato não linear em furo circular com <b>folga radial</b> e, agora, <b>furo oblongo orientável</b> idealizado por geometria cápsula, com movimento livre, folga e bearing unilateral elástico/bilinear. <b>Punção</b> possui kernel de demanda V/Mx/My no perímetro crítico, com distribuição de τ e extremos. Resistências normativas, flexibilidade/plastificação explícita da chapa e ruptura de cone/borda de concreto permanecem como módulos separados em desenvolvimento.';
  });
}
