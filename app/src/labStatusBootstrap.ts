...
function patchLabStatus(){
  document.querySelectorAll<HTMLElement>('[data-testid="model-lab-overlay"]').forEach(overlay=>{
    ...
    note.innerHTML='<b>Lab v0.30:</b> vigas, pilares e barras isoladas usam os solvers estruturais do AstraStruct. <b>Ancoragem / pull-out</b> possui kernel dedicado de aderência τ–s com pós-pico. <b>Ligação chapa–parafuso</b> possui distribuição elástica de Fx/Fy/Mz por placa rígida. <b>Punção</b> possui kernel de demanda V/Mx/My no perímetro crítico, com distribuição de τ e extremos. Resistência normativa de punção, contato avançado, bearing/plastificação de chapa e ruptura de cone/borda de concreto permanecem como módulos separados em desenvolvimento.';
  });
}
