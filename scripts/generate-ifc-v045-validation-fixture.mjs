...
const project={
  ...
  materials:[
    {id:'S355',name:'Steel S355',type:'steel',E:200e6,nu:.3},
    {id:'C30',name:'Concrete C30',type:'concrete',E:30e6,nu:.2}
  ],
  sections:[
...
console.log(JSON.stringify({output,schema:envelope.schema,entities:envelope.entities,nodes:roundTrip.nodes,members:roundTrip.members,materialAssociations:roundTrip.materialAssociations},null,2));
