...
{
 const P=-.8,kz=120,p=model({loads:[{id:'P',nodeId:'N2',fz:P}],springs:[{id:'S1',nodeId:'N2',kz}]}),r=solveFrameCorotational3DWithDeadLoads(p,{steps:4,tolerance:5e-10}),kb=3*E*Iy/L**3,expected=P/(kb+kz);
...
{
 const M=.6,kr=2500,p=model({loads:[{id:'M',nodeId:'N2',mz:M}],springs:[{id:'S1',nodeId:'N2',kr}]}),r=solveFrameCorotational3DWithDeadLoads(p,{steps:4,tolerance:5e-10}),theta=r.displacements[1].rz;
