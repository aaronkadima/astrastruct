...
async function loadProject(page:any){await page.addInitScript((value:any)=>localStorage.setItem('astrastruct.project',JSON.stringify(value)),project);await page.goto('./')}
