...
export function solveEnvelope(project,scenarioIds=null){
  ...
  return{type:'scenario-envelope',analysisType:project.settings?.analysisType||'linear',scenarioIds:ids,scenarios:solved.map(r=>r.scenario),nodeDisplacements:[...nodeMap.values()],elementResponses:[...elementMap.values()],solverVersion:'0.10.0'};
}
